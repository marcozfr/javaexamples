    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns GeoIpServicePortType
     */
    @WebEndpoint(name = "GeoIPServiceSoap")
    public GeoIpServicePortType getGeoIPServiceSoap() {
        return super.getPort(new QName("http://www.webservicex.net/", "GeoIPServiceSoap"), GeoIpServicePortType.class);
    }
     ...
     */
    @WebEndpoint(name = "GeoIPServiceSoap")
    public GeoIpServicePortType getGeoIPServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webservicex.net/", "GeoIPServiceSoap"), GeoIpServicePortType.class, features);
    }

...
/**
 *  RespuestaType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RespuestaType implements org.apache.axis2.databinding.ADBBean {
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"respuestaType".equals(type)) {
                            ...
                            return (RespuestaType) pe.gob.sunedu.wsgt.gradosws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName("", "fechaSunedu").equals(
                                    reader.getName())) ||
                                new javax.xml.namespace.QName("", "fechaSunedu").equals(
                                    reader.getName())) {
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName("", "horaSunedu").equals(
                                    reader.getName())) ||
                                new javax.xml.namespace.QName("", "horaSunedu").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName("", "cGenerico").equals(
                                    reader.getName())) ||
                                new javax.xml.namespace.QName("", "cGenerico").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName("", "dGenerica").equals(
                                    reader.getName())) ||
                                new javax.xml.namespace.QName("", "dGenerica").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",

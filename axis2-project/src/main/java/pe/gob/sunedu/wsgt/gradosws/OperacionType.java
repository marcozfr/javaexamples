...
/**
 *  OperacionType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class OperacionType implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"operacionType".equals(type)) {
                            ...
                            return (OperacionType) pe.gob.sunedu.wsgt.gradosws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName("", "mac_wsServer").equals(
                                    reader.getName())) ||
                                new javax.xml.namespace.QName("", "mac_wsServer").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName("", "ip_wsServer").equals(
                                    reader.getName())) ||
                                new javax.xml.namespace.QName("", "ip_wsServer").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName("", "ip_wsUser").equals(
                                    reader.getName())) ||
                                new javax.xml.namespace.QName("", "ip_wsUser").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
